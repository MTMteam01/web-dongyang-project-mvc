<%@page import="Model.ReservationManager"%>
        ...
        <div class="mb-3">
            ...
            <div class="row row-cols-md-5 g-2" style="color:grey">
                ...
                <c:forEach var="seat" items="${seats}">
                    <div class="col">
                        <button type="button" class="btn btn-outline-dark mb-2 mint-text" onclick="selectSeat('${seat}')">${seat}</button>
...
<button type="button" class="btn btn-primary" onclick="completeReservation()" >예매 완료</button>
