...
<div id = "Box_Office">
	...
	<div class="card text-bg-dark">
		<img src="https://img.megabox.co.kr/SharedImg/2023/11/22/aM1zeiVGySigNObspcjcoH9NaebEPa2f_420.jpg" class="card-img" alt="서울의봄">
			<div class="card-img-overlay">
	    		<h5 class="card-title">서울의 봄</h5>
	    		<p class="card-text">1979년 12월 12일, 수도 서울 군사반란 발생 그날, 대한민국의 운명이 바뀌었다</p>
	  		</div>
	</div>
	<div class="card text-bg-dark">
		<img src="https://img.megabox.co.kr/SharedImg/2023/11/14/gOM47v1Z75W0lzLSPT06Jd3khuBe6Xti_420.jpg" class="card-img" alt="서울의봄">
			<div class="card-img-overlay">
	    		<h5 class="card-title">서울의 봄</h5>
	    		<p class="card-text">1979년 12월 12일, 수도 서울 군사반란 발생 그날, 대한민국의 운명이 바뀌었다</p>
	  		</div>
